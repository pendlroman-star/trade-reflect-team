...
5. **＋ Trade eintragen** (oben rechts, öffnet ein Fenster): Konto und Kategorie wählen, Ergebnis eintragen. Ein Trade ist eine Idee und darf aus mehreren Orders bestehen: mit **„＋ weitere Order“** kommen Zeilen für Lot, Entry und Ergebnis dazu, gezählt wird immer der Trade. Trägst du innerhalb von 30 Minuten noch einmal dasselbe Symbol in derselben Richtung ein, fragt das Fenster, ob die Order zum laufenden Trade gehört. In der Historie klappt das Etikett „N Orders“ die einzelnen Orders auf. Alles wird automatisch in der eigenen Cloud-Datenbank gespeichert.
