/* ============================================================
   ...
   2. "Publishable key" (beginnt mit sb_publishable_) oder der ältere
      "anon public" Key (beginnt mit eyJ) → SUPABASE_ANON_KEY
...
window.SUPABASE_URL      = "https://alumuoetjmyruvccybeb.supabase.co";
window.SUPABASE_ANON_KEY = "sb_publishable_aBcO3ER8VFtGyh93WriPhg_uihX9EEY";
